<?php $__env->startSection('title', 'Data Permissions'); ?>
...
<?php $component = App\View\Components\Breadcrumbs::resolve(['title' => ''.e(__('Permissions')).'','items' => [
      ...
      <section class="section dashboard">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title"><?php echo e(__('Permissions Data')); ?></h5>
                <div class="add-btn-container">
                  <a href="<?php echo e(route('permissions.create')); ?>" class="btn-add-item">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12h4m-2 2v-4M4 18v-1a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v1a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1Zm8-10a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
                    </svg>
                    <?php echo e(__('Add Permissions')); ?>
                  ...
                  <tbody>
                      <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td><?php echo e($permission->created_at->format('d F Y, H:i')); ?></td>
                          <td>
...
<?php $component = App\View\Components\ActionButtons::resolve(['deleteData' => ''.e(route('permissions.destroy', $permission->id)).'','method' => 'DELETE','submit' => 'true','dropdown' => [ 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/daffy/Documents/Projects/PIPAS Invetaris Tanaman/PIPAS-Inventaris-Tanaman/resources/views/role-permission/permission/index.blade.php ENDPATH**/ ?>