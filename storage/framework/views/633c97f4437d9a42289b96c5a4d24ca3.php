...
<?php $component = App\View\Components\Breadcrumbs::resolve(['title' => ''.e(__('Add New Permissions')).'','items' => [
      ...
      <section class="section dashboard">
        <div class="row">
          <div class="col-lg-8">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title"><?php echo e(__('Tambahkan Permissions Baru')); ?></h5>
                <?php if($errors->any()): ?>
                  ...
                  <form action="<?php echo e(route('permissions.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                      ...
                      <div class="form-floating mb-3">
                          ...
                          <label for="floatingInput"><?php echo e(__('Permission Name')); ?></label>
                      </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/daffy/Documents/Projects/PIPAS Invetaris Tanaman/PIPAS-Inventaris-Tanaman/resources/views/role-permission/permission/create.blade.php ENDPATH**/ ?>