...
<?php $component = App\View\Components\NotificationDropdown::resolve(['notificationCount' => $notificationCount,'notifications' => $notifications] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
