...
<?php $component = App\View\Components\Breadcrumbs::resolve(['title' => 'Locations','items' => [
      ...
      <section class="section dashboard"> 
          <div class="row">
              <div class="col-lg-12">
                  <div class="card">
                      <div class="card-body">
                          <h5 class="card-title"><?php echo e(__('Locations Data')); ?></h5>
                          <div class="add-btn-container">
                              <a href="<?php echo e(route('locations.create')); ?>" class="btn-add-item">
