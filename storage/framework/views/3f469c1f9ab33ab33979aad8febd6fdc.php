...
<?php $component = App\View\Components\Breadcrumbs::resolve(['title' => 'Manfaat Tanaman','items' => [
      ...
      <section class="section dashboard">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title"><?php echo e(__('DATA MANFAAT TANAMAN')); ?></h5>
                ...
                <table class="table table-bordered table-hover datatable">
                    <thead>
                        <tr>
                          ...
                          <th><?php echo e(__('NAMA MANFAAT')); ?></th>
