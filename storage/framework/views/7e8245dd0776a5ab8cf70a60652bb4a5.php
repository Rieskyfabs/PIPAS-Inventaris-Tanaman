...
<?php $component = App\View\Components\Breadcrumbs::resolve(['title' => ''.e(__('Edit Location')).'','items' => [
            ...
            <section class="section dashboard">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo e(__('Edit Location')); ?></h5>
                                <?php if($errors->any()): ?>
                                ...
                                <form action="<?php echo e(route('locations.update', $location->id)); ?>" method="POST">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="name" class="form-control" id="floatingInput"
                                            placeholder="name" value="<?php echo e($location->name); ?>" required>
                                        <label for="floatingInput"><?php echo e(__('Location Name')); ?></label>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/daffy/Documents/Projects/PIPAS Invetaris Tanaman/PIPAS-Inventaris-Tanaman/resources/views/admin/pages/locations/edit.blade.php ENDPATH**/ ?>