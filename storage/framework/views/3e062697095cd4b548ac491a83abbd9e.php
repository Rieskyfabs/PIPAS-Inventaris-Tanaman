...
<?php $component = App\View\Components\Card::resolve(['type' => 'plants','title' => 'Tanaman','icon' => 'ri-plant-line','value' => ''.e($totalPlantsQuantity).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal740c66ff9bbfcb19a96a45ba2fa42d64 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal740c66ff9bbfcb19a96a45ba2fa42d64 = $attributes; } ?>
<?php $component = App\View\Components\Card::resolve(['type' => 'location','title' => 'Lokasi Inventaris','icon' => 'ri-map-pin-line','value' => ''.e($totalLocations).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Card::class))->getConstructor()): ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal740c66ff9bbfcb19a96a45ba2fa42d64 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal740c66ff9bbfcb19a96a45ba2fa42d64 = $attributes; } ?>
<?php $component = App\View\Components\Card::resolve(['type' => 'revenue','title' => 'Pengguna','icon' => 'ri-group-line','value' => ''.e($totalUsers).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Card::class))->getConstructor()): ?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if(empty($dataBelumDipanen) && empty($dataSiapDipanen) && empty($dataSudahDipanen)): ?>
                            <p><?php echo e(__('Tidak ada data lokasi yang tersedia.')); ?></p>
                        <?php else: ?>
                            <!-- Column Chart -->
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", () => {
                                    new ApexCharts(document.querySelector("#columnChart"), {
                                        series: [{
                                            name: 'Belum Panen',
                                            data: <?php echo json_encode($dataBelumDipanen, 15, 512) ?>
                                        }, {
                                            name: 'Siap Dipanen',
                                            data: <?php echo json_encode($dataSiapDipanen, 15, 512) ?>
                                        }, {
                                            name: 'Sudah Dipanen',
                                            data: <?php echo json_encode($dataSudahDipanen, 15, 512) ?>
                                        }],
                                        chart: {
                                            type: 'bar',
                                            height: 350
                                        ...
                                        xaxis: {
                                            categories: <?php echo json_encode(array_values($ruangan), 15, 512) ?>,
                                            title: {
                ...
                <?php $__empty_1 = true; $__currentLoopData = $activityLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <div class="activity-item d-flex mb-3">
                    ...
                    <div class="activity-content">
                        <strong><?php echo e($log->action); ?></strong> - <?php echo $log->description; ?>
