                ...
                <form action="<?php echo e(route('plants.update', $plant->id)); ?>" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <select name="status" class="form-select" required>
                            ...
                            <option value="baik" <?php echo e($plant->status == 'baik' ? 'selected' : ''); ?>>Baik</option>
                            <option value="layu" <?php echo e($plant->status == 'layu' ? 'selected' : ''); ?>>Layu</option>
                            <option value="sakit" <?php echo e($plant->status == 'sakit' ? 'selected' : ''); ?>>Sakit</option>
                        </select>
