...
<?php $component = App\View\Components\Breadcrumbs::resolve(['title' => ''.e(__('Edit Roles')).'','items' => [
      ...
      <section class="section dashboard">
        <div class="row">
          <div class="col-lg-8">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title"><?php echo e(__('Edit Roles')); ?></h5>
                <?php if($errors->any()): ?>
                ...
                <!-- Advanced Form Elements -->
                  <form action="<?php echo e(route('roles.update', $role->id)); ?>" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="name" class="form-control" id="floatingInput" value="<?php echo e(old('name', $role->name)); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/daffy/Documents/Projects/PIPAS Invetaris Tanaman/PIPAS-Inventaris-Tanaman/resources/views/role-permission/role/edit.blade.php ENDPATH**/ ?>