    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <?php if(auth()->guard()->check()): ?>
            ...
            <?php if(Auth::user()->role->name == 'user'): ?>
                ...
                <!-- My Plants Nav -->
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('my-plants') ? '' : 'collapsed'); ?>" href="#">
                ...
                <!-- Reports Nav -->
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('reports*') ? '' : 'collapsed'); ?>" href="#">
                ...
                <li class="nav-item">
                    ...
                    <ul id="settings-nav" class="nav-content collapse <?php echo e(Request::is('settings*') ? 'show' : ''); ?>" data-bs-parent="#sidebar-nav">
                        <li>
                            <a class="<?php echo e(Request::is('settings/profile-settings') ? 'active' : ''); ?>" href="#">
