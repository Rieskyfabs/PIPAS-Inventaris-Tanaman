    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <?php if(auth()->guard()->check()): ?>
            ...
            <?php if(Auth::user()->role->name == 'user'): ?>
                ...
                <!-- Reports Nav -->
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('/reports*') ? '' : 'collapsed'); ?>" data-bs-target="#plants-report-nav" data-bs-toggle="collapse" href="#">
                        <i class='bx bx-printer fs-5'></i><span><?php echo e(__('Laporan')); ?></span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="plants-report-nav" class="nav-content collapse <?php echo e(Request::is('reports*') ? 'show' : ''); ?>" data-bs-parent="#sidebar-nav">
                        <li>
                            <a class="<?php echo e(Request::is('reports/tanaman-masuk') ? 'active' : ''); ?>" href="<?php echo e(route('users.reports.tanaman-masuk')); ?>">
                                <i class="bi bi-circle"></i><span><?php echo e(__('Lap. Tanaman Masuk')); ?></span>
                            </a>
                        </li>
                        <li>
                            <a class="<?php echo e(Request::is('reports/tanaman-keluar') ? 'active' : ''); ?>" href="<?php echo e(route('users.reports.tanaman-keluar')); ?>">
            ...
            <?php else: ?>
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('admin/reports*') ? '' : 'collapsed'); ?>" data-bs-target="#plants-report-nav" data-bs-toggle="collapse" href="#">
                        <i class='bx bx-printer fs-5'></i><span><?php echo e(__('Kelola Laporan')); ?></span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="plants-report-nav" class="nav-content collapse <?php echo e(Request::is('admin/reports*') ? 'show' : ''); ?>" data-bs-parent="#sidebar-nav">
                        <li>
                            <a class="<?php echo e(Request::is('admin/reports/tanaman-masuk') ? 'active' : ''); ?>" href="<?php echo e(route('reports.tanaman-masuk')); ?>">
                                <i class="bi bi-circle"></i><span><?php echo e(__('Lap. Tanaman Masuk')); ?></span>
                            </a>
                        </li>
                        <li>
                            <a class="<?php echo e(Request::is('admin/reports/tanaman-keluar') ? 'active' : ''); ?>" href="<?php echo e(route('reports.tanaman-keluar')); ?>">
                                <i class="bi bi-circle"></i><span><?php echo e(__('Lap. Tanaman Keluar')); ?></span>
                            </a>
                        </li>
                    </ul>
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('admin/notifications*') ? '' : 'collapsed'); ?>" href="<?php echo e(route('notifications')); ?>">
                        <i class="bx bxs-bell-ring fs-5"></i>
                        <span><?php echo e(__('Notifikasi')); ?>  
                            <?php if($notificationCount > 0): ?>
                                <span class="badge bg-warning"><?php echo e($notificationCount); ?></span>
                    ...
                    <ul id="settings-nav" class="nav-content collapse <?php echo e(Request::is('admin/settings*') ? 'show' : ''); ?>" data-bs-parent="#sidebar-nav">
                        <li>
                            <a class="<?php echo e(Request::is('admin/settings/profile-settings') ? 'active' : ''); ?>" href="#">
                                <i class="bi bi-circle"></i><span><?php echo e(__('Profil Saya')); ?></span>
                            </a>
                        </li>
                        <!-- Kelola Pengguna -->
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(Request::is('admin/settings/users*') || Request::is('admin/role-permissions*') ? '' : 'collapsed'); ?>" data-bs-target="#users-nav" data-bs-toggle="collapse" href="#">
                                <i class="bi bi-circle-fill"></i><span><?php echo e(__('Pengguna')); ?></span><i class="bi bi-chevron-down ms-auto me-3 fs-6"></i>
                            </a>
                            <ul id="users-nav" class="nav-content collapse <?php echo e(Request::is('admin/settings/users*') || Request::is('admin/settings/role-permissions*') ? 'show' : ''); ?> ps-3" data-bs-parent="#settings-nav">
                                <li>
                                    <a class="<?php echo e(Request::is('admin/settings/users*') ? 'active' : ''); ?>" href="<?php echo e(route('users')); ?>">
                                        <i class="bi bi-circle"></i><span><?php echo e(__('List Pengguna')); ?></span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e(Request::is('admin/settings/role-permissions*') ? '' : 'collapsed'); ?>" data-bs-target="#roles-permissions-subnav" data-bs-toggle="collapse" href="#">
                                        <i class="bi bi-circle-fill"></i><span><?php echo e(__('Roles & Permissions')); ?></span><i class="bi bi-chevron-down ms-auto me-3 fs-6"></i>
                                    </a>
                                    <ul id="roles-permissions-subnav" class="nav-content collapse <?php echo e(Request::is('admin/settings/role-permissions*') ? 'show' : ''); ?> ps-3" data-bs-parent="#users-nav">
                                        <li>
                                            <a class="<?php echo e(Request::is('admin/settings/role-permissions/permissions*') ? 'active' : ''); ?>" href="<?php echo e(route('permissions')); ?>">
                                                <i class="bi bi-circle"></i><span><?php echo e(__('Permissions')); ?></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="<?php echo e(Request::is('admin/settings/role-permissions/roles*') ? 'active' : ''); ?>" href="<?php echo e(route('roles')); ?>">
