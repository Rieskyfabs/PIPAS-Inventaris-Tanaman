...
<head>
	<meta charset="utf-8">
	<title><?php echo e($title ?? 'DAMASU'); ?></title>
                        ...
                        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(Auth::user()->role->name == 'admin'): ?>
                                    <a href="<?php echo e(route('admin/dashboard')); ?>" class="btn-login"><i class="fas fa-sign-in-alt"></i> Admin Dashboard</a>
                                <?php elseif(Auth::user()->role->name == 'master'): ?>
                                    <a href="<?php echo e(route('master/dashboard')); ?>" class="btn-login"><i class="fas fa-sign-in-alt"></i> Master Dashboard</a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-login"><i class="fas fa-sign-in-alt"></i> User Dashboard</a>
                                <?php endif; ?>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="btn-login"><i class="fas fa-sign-in-alt"></i> Login</a>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                  </div>
                          ...
                          <div class="box">
                            <?php if(Route::has('login')): ?>
                                <?php if(auth()->guard()->check()): ?>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('dashboard')); ?>" class="btn-login">
                  ...
                  <div class="container galeri-wrapper">
                      ...
                      <div class="row2">
                          <div class="card-galeri">
                              <!-- Card 1 -->
                              <div class="card">
                                  <img src="<?php echo e(asset('/images/daur1.jpg')); ?>" alt="Kegiatan Kepedulian">
                                  <h3>Tanam & Panen Sayuran</h3>
                                  <p>Kepedulian</p>
                              </div>
                              <!-- Card 2 -->
                              <div class="card">
                                  <img src="<?php echo e(asset('/images/daur1.jpg')); ?>" alt="Kegiatan Kerja Sama">
                                  <h3>Tanam & Panen Sayuran</h3>
                                  <p>Kerja Sama</p>
                              </div>
                              <!-- Card 3 -->
                              <div class="card">
                                  <img src="<?php echo e(asset('/images/daur1.jpg')); ?>" alt="Kegiatan Kritis">
                                  <div class="card-text">
                                      <h3>Tanam & Panen Sayuran</h3>
                                      <p>Kritis</p>
                                  </div>
                  ...
                  <div class="container highlighted-cta-wrapper">
                      <div class="content-left">
                          ...
                          <div class="cta-box-wrapper">
                              <div class="box-cta">
                                  <a href="<?php echo e(route('login')); ?>" class="btn-login"><i class="fas fa-sign-in-alt"></i> Login Sekarang</a>
                              </div>
                          </div>
                      </div>
                      <div class="content-right">
                          <div class="img-wrapper">
                              <img src="<?php echo e(asset('/images/Mockup1.png')); ?>" alt="Dua orang siswa dengan latar belakang tanaman" class="image">
                          </div>
                      </div>
                  </div>
              </section>
...
<?php /**PATH /home/daffy/Documents/Projects/PIPAS Invetaris Tanaman/PIPAS-Inventaris-Tanaman/resources/views/landingPage.blade.php ENDPATH**/ ?>