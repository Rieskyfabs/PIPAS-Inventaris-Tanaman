...
<?php $component = App\View\Components\Breadcrumbs::resolve(['title' => ''.e(__('Pengguna')).'','items' => [
...
<?php endif; ?>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title"><?php echo e(__('Data Pengguna')); ?></h5>
