              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div class="add-btn-container d-flex">
                        <a href="<?php echo e(route('reports.tanaman-keluar.export.excel', ['start_date' => request('start_date'), 'end_date' => request('end_date'), 'type' => 'keluar'])); ?>" class="btn btn-success me-2" data-bs-toggle="tooltip" title="Export to Excel">
                            <i class="bi bi-file-earmark-excel"></i> Export Excel
                        </a>
                        <a href="<?php echo e(route('reports.tanaman-keluar.export.pdf', ['start_date' => request('start_date'), 'end_date' => request('end_date'), 'type' => 'keluar'])); ?>" class="btn btn-danger me-2" data-bs-toggle="tooltip" title="Export to PDF">
                            <i class="bi bi-file-earmark-pdf"></i> Export PDF
                        </a>
                        <a href="<?php echo e(route('reports.tanaman-keluar.print', ['start_date' => request('start_date'), 'end_date' => request('end_date'), 'type' => 'keluar'])); ?>" class="btn btn-secondary" data-bs-toggle="tooltip" title="Print">
                            <i class="bi bi-printer"></i> Print
                        </a>
                    </div>

                    <form method="GET" action="<?php echo e(route('reports.tanaman-keluar')); ?>" class="d-flex align-items-end">
                        <div class="d-flex">
                            <div class="me-2">
                        ...
                        <a href="<?php echo e(route('reports.tanaman-keluar')); ?>" class="btn btn-secondary"><?php echo e(__('Reset')); ?></a>
                    </form>
                </div>
