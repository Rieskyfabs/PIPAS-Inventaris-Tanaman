<section id="contact-form" class="py-10 px-4 sm:px-8">
    <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between max-w-6xl bg-white rounded-2xl shadow-lg p-6 sm:p-8">
        ...
        <div class="w-full lg:w-1/2 text-center lg:text-left lg:pr-10">
            ...
            <div class="mt-8">
                ...
                <div class="flex gap-4 mt-4 justify-center lg:justify-start">
                    ...
                    <a href="https://twitter.com" target="_blank" aria-label="Twitter" class="flex items-center justify-center w-10 h-10 bg-[#E5F4F2] text-[#333333] rounded-full transition-transform transform hover:scale-110 hover:bg-[#1DA1F2]">
        ...
        <div class="w-full lg:w-1/2 mt-10 lg:mt-0">
            <form action="#" method="post" class="flex flex-col gap-6">
                <div class="relative">
                    <span class="absolute left-4 top-3 text-[#009379]">
                        <i class="fa-solid fa-user"></i>
                    </span>
                    <input type="text" name="nama_lengkap" placeholder="Nama Lengkap" required class="w-full pl-12 pr-4 py-3 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#009379]">
                </div>
                <div class="relative">
                    <span class="absolute left-4 top-3 text-[#009379]">
                        <i class="fa-solid fa-envelope"></i>
                    </span>
                    <input type="email" name="email" placeholder="Email" required class="w-full pl-12 pr-4 py-3 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#009379]">
                </div>
                <button type="submit" class="py-3 bg-[#009379] text-white font-semibold rounded-lg transition hover:bg-[#007d66] focus:ring-4 focus:ring-[#009379] focus:ring-opacity-50">
                    Kirim
                </button>
            </form>
        </div>
